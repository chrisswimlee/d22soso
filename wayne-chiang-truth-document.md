...
- **[FIRST-PARTY]** — Wayne’s documentation / `starcraftbio.md`; publishable as his account.
...
- Mechanic: 4 hole cards split into two independent 2-card hands vs one board [PUBLIC-VERIFIED].
- Main-game house edge **4.06%** [FIRST-PARTY].
- WSGC approval submission #3192; bonus edges published (Flounder 4 ~10.96%, Nessie 9 ~10.75%) [PUBLIC-VERIFIED].
- Live at Great American Casino Tukwila via Maverick Gaming [PUBLIC-VERIFIED / FIRST-PARTY].
- Commerce Casino & Hustler Casino (LA) launches planned [FIRST-PARTY].
- Licensing rate sheet → CONFIDENTIAL (local only).

### Badugi Chase™
- US Patents **11,810,421**, **12,131,608** (+ earlier grants 10,360,759 / 10,930,111 / 11,436,891) [PUBLIC-VERIFIED].
- Single-draw lowball; 3 community cards; player selects exactly 1 [FIRST-PARTY].
- House edge **1.22%** of total volume [FIRST-PARTY].
- Developed with Charles Chang and Joe Shipman, Ph.D. [FIRST-PARTY].
...
- First-party tables (2026); `starcraftbio.md`
